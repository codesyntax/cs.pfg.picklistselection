...
def setup_product():
    ...
    import cs.picklistselection
    zcml.load_config('configure.zcml', cs.picklistselection)
    ...
    ztc.installPackage('cs.picklistselection')
...
setup_product()
ptc.setupPloneSite(products=['cs.picklistselection'])
